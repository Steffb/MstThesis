...
class LearningSwitch (object):
  ...
  def __init__ (self, connection, transparent):
    ...
    '''
    #Set normal flowrules in switch
    msg = of.ofp_flow_mod()
    ...
    if(connection.dpid in dpid_to_name.keys() and  dpid_to_name[connection.dpid] == 'p1'):

      

    if(connection.dpid in dpid_to_name.keys() and  dpid_to_name[connection.dpid] == 'p2'):
